...
const PrincipalDashboard = () => {
    ...
    const navItems = [
        ...
        { id: 'examination', label: 'Examination Management', icon: '📝' },
        { id: 'fee', label: 'Fee Management', icon: '💰' },
        { id: 'admission', label: 'Admission Management', icon: '🎓' },
        { id: 'staff', label: 'Staff Management', icon: '👥' },
        { id: 'communication', label: 'Communication Center', icon: '📢' },
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'examination': return <ExaminationManagement />;
            case 'fee': return <FeeManagement />;
                        ...
                        {navItems.map(item => (
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: activeTab === item.id ? 'inset 3px 0 0 #38bdf8' : 'none'
                                }}
