    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex justify-between items-center">
                <h2 className="m-0 text-2xl text-slate-900">Student Transport Allocation</h2>
                {activeTab === 'list' && (
                        ...
                        <table className="w-full border-collapse text-left">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-sm font-semibold text-slate-600">Pickup / Drop Point</th>
                                    <th className="px-6 py-4 text-sm font-semibold text-slate-600">Assigned Bus & Route</th>
