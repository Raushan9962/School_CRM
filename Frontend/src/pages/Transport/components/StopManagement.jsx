    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex justify-between items-center">
                <h2 className="m-0 text-2xl text-slate-900">Stop Management</h2>
                {activeTab === 'list' && (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse text-left">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="px-6 py-4 text-sm font-semibold text-slate-600">Stop Name & ID</th>
                                    <th className="px-6 py-4 text-sm font-semibold text-slate-600">Location</th>
                                    <th className="px-6 py-4 text-sm font-semibold text-slate-600">Timings (Pickup/Drop)</th>
                            ...
                            <tbody>
                                {stops.map((s, idx) => (
                                    <tr key={idx} className="border-b border-slate-200">
                                        ...
                                        <td className="px-6 py-4 text-sm text-slate-600">{s.location}</td>
                                        <td className="px-6 py-4">
