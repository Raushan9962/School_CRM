    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <h2 className="m-0 text-xl text-slate-900">Driver Management</h2>
                {activeTab === 'list' && (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse text-left">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Driver Name & ID</th>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Contact</th>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">License Details</th>
                            ...
                            <tbody>
                                {drivers.map((d, idx) => (
                                    <tr key={idx} className="border-b border-slate-200">
                                        ...
                                        <td className="px-4 py-2 text-sm text-slate-600">{d.mobile}</td>
                                        <td className="px-4 py-2">
                                        ...
                                        <td className="px-4 py-2 text-sm text-slate-600">{d.route}</td>
                                        <td className="px-4 py-2">
