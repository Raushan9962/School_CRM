    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center">
                <h2 className="m-0 text-xl text-slate-900">Vehicle Management</h2>
                {activeTab === 'list' && (
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse text-left">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Bus No</th>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Registration</th>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Type & Capacity</th>
                                    <th className="px-4 py-2 text-sm font-semibold text-slate-600">Fitness Due</th>
                            ...
                            <tbody>
                                {vehicles.map((v, idx) => (
                                    <tr key={idx} className="border-b border-slate-200">
                                        ...
                                        <td className="px-4 py-2 text-sm text-slate-600">{v.regNo}</td>
                                        ...
                                        <td className="px-4 py-2 text-sm text-slate-600">{v.nextFitness}</td>
                                        <td className="px-4 py-2">
