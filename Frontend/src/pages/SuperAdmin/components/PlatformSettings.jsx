...
const PlatformSettings = () => {
  return (
    <div className="animate-fade-in">
      <div className="mb-4">
        <h2 className="text-xl font-extrabold text-indigo-950 m-0">Platform Settings</h2>
      ...
      <div style={{ 
        ...
        <h3 className="m-0 mb-4 text-sm font-bold text-slate-800">Global Configurations</h3>
