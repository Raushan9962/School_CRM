  ...
  return (
    <div className="animate-fade-in">
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ fontSize: '24px', fontWeight: '800', color: '#1e1b4b', margin: '0' }}>Finance Management</h2>
        <p style={{ color: '#64748b', fontSize: '14px', marginTop: '4px' }}>Manage accountants, fees collection, and history.</p>
      </div>
      ...
      <div style={{ 
        ...
        <h3 style={{ margin: '0 0 16px', fontSize: '16px', fontWeight: '700', color: '#1e293b' }}>Finance Overview</h3>
        <p style={{ color: '#64748b' }}>Accountant profiles and fee ledgers will appear here.</p>
      </div>
    </div>
  );
};
